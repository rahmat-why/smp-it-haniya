...
class GradeController extends Controller
{
    ...
    public function create()
    {
        ...
        // load grade types from mst_detail_settings where header_id = 'GRADE_TYPE'
    ...
    public function store(StoreGradeRequest $request)
    {
        ...
        try {
            ...
            // 🔥 FIXED: Detail IDs now use GRDxxxxxx
            ...
            foreach ($validated['grades'] as $grade) {
                ...
                if ($existing) {
                    ...
                    // 🔥 Create detail ID with correct prefix
    ...
    public function edit($gradeId)
    {
        ...
        // dropdown data sama seperti create()
        ...
        $gradeTypes = DB::select("
            SELECT detail_id, item_code, item_name
            FROM mst_detail_settings
            WHERE header_id = 'GRADE_TYPE' AND status = 'ACTIVE'
            ORDER BY item_name ASC
        ");
