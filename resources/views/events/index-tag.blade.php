        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <a href="{{ route('employee.events.index') }}" class="text-white text-decoration-none">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        Tags for Event: <strong>{{ $event->event_name }}</strong>
                    </h5>
                    <a href="{{ route('employee.events.create-tag', $event->event_id) }}" class="btn btn-light btn-sm">
                            ...
                            <tbody>
                                @forelse ($tags as $tag)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('employee.events.destroy-tag', [$event->event_id, $tag->tag_id]) }}" 
