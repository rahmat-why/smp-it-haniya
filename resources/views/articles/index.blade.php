    ...
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
        ...
        <div class="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
            <h5 class="fw-bold mb-0">
                <i class="fas fa-newspaper text-primary"></i> Articles List
            </h5>
        ...
        <div class="card-body px-4">
            ...
            <div class="bg-white border rounded p-3 shadow-sm">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle w-100" id="articlesTable">
...
$(function() {
    ...
    $('#articlesTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('employee.articles.data') }}",
        columns: [
                    ...
                    return `
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="/articles/edit/${id}">
        ...
        order: [[0, 'desc']],
        autoWidth: false // menyesuaikan kolom dengan lebar container
    });
