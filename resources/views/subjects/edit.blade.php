...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form id="subject-form" action="{{ route('employee.subjects.update', $subject->subject_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="subject_id" 
                               value="{{ $subject->subject_id }}" disabled>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('class_level') is-invalid @enderror" 
                               id="class_level" name="class_level" value="{{ old('class_level', $subject->class_level) }}" required>
                        @error('class_level')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
