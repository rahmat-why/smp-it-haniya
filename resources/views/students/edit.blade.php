...
<div class="row">
    <div class="col-md-10 offset-md-1">
        <div class="card">
            ...
            <div class="card-body">
                <form id="student-form" action="{{ route('employee.students.update', $student->student_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="mb-2 text-center">
                            @if(!empty($student->profile_photo))
                                <img id="photoPreview" src="{{ asset('storage/' . $student->profile_photo) }}" alt="photo" width="120" height="120" class="rounded-circle mb-2" style="object-fit:cover;" />
                            @else
        ...
        let ajaxOptions = {
            ...
            error: function(xhr){
                if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                    ...
                    alert(xhr.responseJSON?.message || 'Failed to update student');
                }
            }
        };
