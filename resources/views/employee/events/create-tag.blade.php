        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <a href="{{ route('employee.events.tag', $event->event_id) }}" class="text-white text-decoration-none">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        Add Tags to Event: {{ $event->event_name }}
                    </h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('employee.events.store-tag', $event->event_id) }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('employee.events.tag', $event->event_id) }}" class="btn btn-secondary">
